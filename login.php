...
$phone = '254' . substr($contactno, -9); // Format phone number with Kenyan code
$password=md5($_POST['password']);
$billingAddress = 'Nairobi'; // Default billing address
$billingState = 'Nairobi';
$billingCity = 'Nairobi';
$billingPincode = 00100;
$shippingAddress = 'Nairobi'; // Default shipping address
$shippingState = 'Nairobi';
$shippingCity = 'Nairobi';
$shippingPincode = 00100;

$query=mysqli_query($con,"insert into users(name, firstname, lastname, email, contactno, phone, password, billingAddress, billingState, billingCity, billingPincode, shippingAddress, shippingState, shippingCity, shippingPincode) values('$name','$firstname','$lastname','$email','$contactno','$phone','$password','$billingAddress','$billingState','$billingCity','$billingPincode','$shippingAddress','$shippingState','$shippingCity','$shippingPincode')");
if($query)
{
