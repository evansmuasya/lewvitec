            ...
            <div class='col-md-12'>
                <div class="search-result-container" style="padding: 20px;">
                    <div class="category-product">
                        ...
                        $countQuery = mysqli_query($con, "SELECT COUNT(*) AS total FROM products WHERE subCategory='$scid'");
                        $countRow = mysqli_fetch_assoc($countQuery);
                        $total = $countRow['total'];
                        $pages = ceil($total / $limit);

                        $ret = mysqli_query($con, "SELECT * FROM products WHERE subCategory='$scid' ORDER BY id DESC LIMIT $start, $limit");
